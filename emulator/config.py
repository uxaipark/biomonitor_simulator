...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "scenario": {
        ...
        "rf_noise": {"enabled": False, "level": 60},
        "realsig": {"enabled": False, "auto_cycle": True, "cycle_s": 60, "slots": [""] * 20},   # 실제 시그널 송출: 슬롯별 로컬 ATF/CSV 파일 반복 재생, 빈 슬롯은 부정맥 순환   # 2.4 GHz 대역 혼잡: BLE RSSI 감쇠·흔들림, 짧은 BLE 끊김, 무선 AP 경유 GW 손실·지연
