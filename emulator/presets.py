...
POINTS.update({'performance': (['병상 2,500 · 패치 2,000 · 원외 MCOT 200명 (혼합)', '네트워크 · 게이트웨이 장애 꺼짐', '아티팩트 · 일과 · 임상 악화는 기본값'], ''),
...
def differs(a: dict, b: dict) -> bool:
    """편집 가능 경로에서 두 설정이 다른가."""
    return filter_values(a) != filter_values(b)
